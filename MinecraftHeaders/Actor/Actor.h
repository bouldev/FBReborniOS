...
public:
  ...
  virtual int checkAllSensitiveWords(int a1);
  virtual ~Actor();
  ...
  //virtual unsigned int64_t getNameTagAsHash(void) const;
  ...
  virtual bool add_(class ItemStack &);
  virtual bool drop_(class ItemStack const &, bool);
